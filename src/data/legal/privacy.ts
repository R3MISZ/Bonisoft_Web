...
export const privacy: LegalSection[] = [
  {
    ...
    blocks: [
      { kind: "h", text: "Allgemeine Hinweise" },
      {
        kind: "p",
      ...
      { kind: "h", text: "Datenerfassung auf dieser Website" },
      { kind: "hs", text: "Wer ist verantwortlich für die Datenerfassung auf dieser Website?" },
      {
        kind: "p",
      ...
      { kind: "hs", text: "Wie erfassen wir Ihre Daten?" },
      {
        kind: "p",
      ...
      { kind: "hs", text: "Wofür nutzen wir Ihre Daten?" },
      {
        kind: "p",
      ...
      { kind: "hs", text: "Welche Rechte haben Sie bezüglich Ihrer Daten?" },
      {
        kind: "p",
      ...
      { kind: "h", text: "Analyse-Tools und Tools von Drittanbietern" },
      {
        kind: "p",
  ...
  },
  {
    ...
    title: "2. Hosting",
    blocks: [
      { kind: "p", text: "Wir hosten die Inhalte unserer Website bei folgendem Anbieter:" },
      { kind: "h", text: "Strato" },
      {
        kind: "p",
      ...
      {
        kind: "p",
        text: "Weitere Informationen entnehmen Sie der Datenschutzerklärung von Strato: https://www.strato.de/datenschutz/.",
      },
      {
        kind: "p",
        text: "Die Verwendung von Strato erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an einer möglichst zuverlässigen Darstellung unserer Website. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers (z. B. Device-Fingerprinting) im Sinne des TDDDG umfasst. Die Einwilligung ist jederzeit widerrufbar.",
      },
      { kind: "hs", text: "Auftragsverarbeitung" },
      {
        kind: "p",
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "h", text: "Hinweis zur verantwortlichen Stelle" },
      {
        kind: "p",
        text: "Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:",
      },
      { kind: "p", text: "BoniSoft Technologies GmbH, Kurallee 1a, 24159 Kiel" },
      { kind: "p", text: "E-Mail: info@bonisoft.de" },
      {
        kind: "p",
      ...
      { kind: "h", text: "Empfänger von personenbezogenen Daten" },
      {
        kind: "p",
      ...
      { kind: "h", text: "Widerruf Ihrer Einwilligung zur Datenverarbeitung" },
      {
        kind: "p",
      ...
      { kind: "h", text: "Beschwerderecht bei der zuständigen Aufsichtsbehörde" },
      {
        kind: "p",
      ...
      { kind: "h", text: "Recht auf Datenübertragbarkeit" },
      {
        kind: "p",
      ...
      { kind: "h", text: "Auskunft, Berichtigung und Löschung" },
      {
        kind: "p",
      ...
      { kind: "h", text: "Recht auf Einschränkung der Verarbeitung" },
      {
        kind: "p",
      ...
      { kind: "h", text: "SSL- bzw. TLS-Verschlüsselung" },
      {
        kind: "p",
      ...
      { kind: "h", text: "Widerspruch gegen Werbe-E-Mails" },
      {
        kind: "p",
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "h", text: "Anfrage per E-Mail, Telefon oder Telefax" },
      {
        kind: "p",
  ...
  },
  {
    ...
    blocks: [
      { kind: "h", text: "Matomo" },
      { kind: "p", text: "Diese Website benutzt den Open Source Webanalysedienst Matomo." },
      {
        kind: "p",
        text: "Mit Hilfe von Matomo sind wir in der Lage Daten über die Nutzung unserer Website durch die Websitebesucher zu erfassen und zu analysieren. Hierdurch können wir u. a. herausfinden, wann welche Seitenaufrufe getätigt wurden und aus welcher Region sie kommen. Außerdem erfassen wir verschiedene Logdateien (z. B. IP-Adresse, Referrer, verwendete Browser und Betriebssysteme) und können messen, ob unsere Websitebesucher bestimmte Aktionen durchführen (z. B. Klicks, Käufe u. Ä.).",
      },
      {
        kind: "p",
        text: "Die Nutzung dieses Analyse-Tools erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an der Analyse des Nutzerverhaltens, um sowohl sein Webangebot als auch seine Werbung zu optimieren. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers (z. B. Device-Fingerprinting) im Sinne des TDDDG umfasst. Die Einwilligung ist jederzeit widerrufbar.",
      },
      { kind: "hs", text: "IP-Anonymisierung" },
      {
        kind: "p",
        text: "Bei der Analyse mit Matomo setzen wir IP-Anonymisierung ein. Hierbei wird Ihre IP-Adresse vor der Analyse gekürzt, sodass Sie Ihnen nicht mehr eindeutig zuordenbar ist.",
      },
      { kind: "hs", text: "Hosting" },
      {
        kind: "p",
        text: "Wir hosten Matomo ausschließlich auf unseren eigenen Servern, sodass alle Analysedaten bei uns verbleiben und nicht weitergegeben werden.",
      },
    ],
  },
];
